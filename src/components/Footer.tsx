  ...
  return (
    <div id="footer" data-testid="footer">
      <footer className="footer p-10 bg-base-200 text-base-content">
        ...
        <nav>
          <h6 data-testid="footer-about" className="footer-title">About</h6>
          <p data-testid="footer-about-text" className="w-60">ScanMyBusiness is a website to scan your business for possible improvement and analyze your rivals for their best pointers which you can implement to improve your business.</p>
        </nav>
        <nav>
          <h6 data-testid="footer-pages" className="footer-title">Pages</h6>
          <Link data-testid="footer-pages-home" href="/" className="link link-hover">Home</Link>
          <Link data-testid="footer-pages-about" href="/about" className="link link-hover">About</Link>
          <Link data-testid="footer-pages-contact" href="/contact" className="link link-hover">Contact</Link>
        </nav>
        <nav>
          <h6 data-testid="footer-account" className="footer-title">Account</h6>
          <Link data-testid="footer-login" href="/login" className="link link-hover">Login</Link>
          <Link href="/signup" data-testid="footer-singup" className="link link-hover">Signup</Link>
        </nav>
      </footer>
      <footer className="footer footer-center p-4 bg-base-300 text-base-content">
        <aside>
          <p data-testid="footer-copyright">Copyright © 2025 - All right reserved by ScanMyBusiness Ltd.</p>
        </aside>
      </footer>
    </div>
  );
